...
class _ThoughtScreenState extends State<ThoughtScreen> {
  ...
  Future<void> _addThought() async {
    ...
    Navigator.pop(context, updatedThoughts); // Return to the previous screen with updated thoughts
  }
                ...
                Row(
                  children: [
                    GestureDetector(
                        ...
                        child: Text("Alpha", style: TextStyle(color: Colors.white, fontSize: 20),)),
