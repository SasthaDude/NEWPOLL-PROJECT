...
final ThemeData myTheme = ThemeData(
  textTheme: TextTheme(
    displayLarge: TextStyle(fontSize: 16.0, letterSpacing: 1,  fontFamily: "Poppins", color: Colors.white60),
    displayMedium: TextStyle(fontSize: 16.0, letterSpacing: .5, fontWeight: FontWeight.w200, fontFamily: "Poppins", color: mlinkColor),
    ...
    titleLarge: TextStyle(fontSize: 27, letterSpacing: .7, color: mWhiteColor, fontWeight: FontWeight.bold, fontFamily: "Poppins"),
    titleMedium: TextStyle(fontSize: 25, letterSpacing: .7, color: mWhiteColor, fontWeight: FontWeight.bold, fontFamily: "Poppins"),
    titleSmall: TextStyle(fontSize: 16, letterSpacing: .5, color: Colors.white, fontWeight: FontWeight.w200,fontFamily: "Poppins"),
